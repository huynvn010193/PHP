...
-- 02. Hiển thị thông tin công trình có chi phí lớn hơn tất cả các công trình xây dựng ở Cần Thơ
-- cach 1
...
-- 03. Hiển thị thông tin công trình có chi phí lớn hơn một trong các công trình xây dựng ở Cần Thơ
...
WHERE EXISTS
	(
		...
		WHERE a.birthday = b.birthday AND a.place = b.place AND a.id <> b.id
	)
